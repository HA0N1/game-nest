...
function goSignup(event) {
  console.log('회원 가입');
  window.location.href = 'https://chunsik.store:3000/user/sign-up';
}
...
function goChannel(event) {
  console.log('채널 입장');
  window.location.href = 'https://chunsik.store:3000/channel/list';
}
...
function goProgile(event) {
  console.log('프로필 이동');
  window.location.href = 'https://chunsik.store:3000/user/userinfo';
}

function goPost(event) {
  console.log('커뮤니티 이동');
  window.location.href = 'https://chunsik.store:3000/post/page';
}
